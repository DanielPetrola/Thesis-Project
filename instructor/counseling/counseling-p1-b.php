...
<table id="customers" >
					...
					<tr>
                      ...
                      <th width="40%;"><a href="counseling-p1-a.php">TO BE ACKNOWLEDGED</a></th>
                      <th width="30%;" style="border-bottom: solid #F0AD4E 7px;"><a style="color:  #F0AD4E;" href="counseling-p1-b.php">FINISHED</a></th>
					</tr> 
				</table>
...
<div class="" style="position: absolute; top: 13%; width: 99%; left: 0.5%; z-index:999;">
                     ...
                     <div class="form-group mb-2">
                        ...
                        <div class="form-group mb-2">
                           ...
                           $email =$_SESSION['useremail'];
                              ...
                              $sql = "SELECT sem FROM crecords1  where status = 'Finished' and uid = '$email' GROUP BY sem";
                     ...
                     <div class="form-group mb-2">
                        ...
                        <div class="form-group mb-2">
                           <select name="sy1"  class="form-control form-control-sm" id="sy1" required>
                              ...
                              <?php 
                                 //echo "<option value='$selectedYear' selected>$selectedYear</option>";
                                 $sql = "SELECT sy FROM crecords1  where status = 'Finished' and uid = '$email' GROUP BY sy";
                                 $stmt = mysqli_stmt_init($conn);
                                 if (!mysqli_stmt_prepare($stmt, $sql)) {
                                     header("location: ../reports/reports-p1.php?error=stmtfailed1");
                                     exit();
               ...
               <div class="form-group sm-2">
               <button class="btn btn-white btn-sm" name="" id="" onclick="location.href='counseling-p1-b.php'"> Reset </button> 
               </div> 
               </div>
               <br>
               <?php
                  ...
                  $sy2 = $_POST['sy2'];
                     ...
                     include 'tables/table-a3-b.php';
                  
                  }else{
                     include 'tables/table-a3-a.php';
                  }
                  ?>    
            </div>
         </div>
