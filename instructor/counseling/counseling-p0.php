   ...
   <body>
      ...
      <div class="center white-div2">
         ...
         <div class="" style="position: absolute;
            top: 7%;
            left: 1%;">
            <button class="btn btn-success btn-sm" onclick="location.href='counseling-p2.php'" style="text-decoration:none;">NEW <i class="white fa fa-plus"></i></button>
         </div>
         <!-- table container -->
         <div class="maroon-div center">
            <div class="card">
               <table id="customers" >
                  <tr>
                     <th width="50%;" style="border-bottom: solid #F0AD4E 7px;"><a style="color:  #F0AD4E;" href="counseling-p0.php">GUIDANCE</a></th>
                     <th width="50%;"><a href="counseling-p1.php">ACADEMIC</a></th>
                  </tr>
               </table>
            </div>
            <div class="" style="position: absolute; top: 13%; width: 99%; left: 0.5%; z-index:999;">
                     ...
                     <div class="form-group mb-2">
                        ...
                        <div class="form-group mb-2">
                           ...
                           <?php 
                              ...
                              $sql = "SELECT sem FROM crecords GROUP BY sem";
                     ...
                     <div class="form-group mb-2">
                        ...
                        <div class="form-group mb-2">
                           <select name="sy1"  class="form-control form-control-sm" id="sy1" required>
                              ...
                              <?php 
                                 //echo "<option value='$selectedYear' selected>$selectedYear</option>";
                                 $sql = "SELECT sy FROM crecords GROUP BY sy";
                                 $stmt = mysqli_stmt_init($conn);
                                 if (!mysqli_stmt_prepare($stmt, $sql)) {
                                     header("location: ../reports/reports-p1.php?error=stmtfailed1");
                                     exit();
               ...
               <div class="form-group sm-2">
               <button class="btn btn-white btn-sm" name="" id="" onclick="location.href='counseling-p0.php'"> Reset </button> 
               </div> 
               </div>
               <br>
               <?php
                  ...
                  $sy2 = $_POST['sy2'];
                     ...
                     include 'tables/table-g2.php';
                  
                  }else{
                     include 'tables/table-g1.php';
                  }
                  ?>    
            </div>
         </div>
