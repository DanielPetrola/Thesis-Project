...
$email = $_SESSION['useremail'];
	...
	if ($sem == 'All') {
		...
		$sql1 = "SELECT * FROM crecords1 WHERE sy>='$sy1' AND sy<='$sy2' AND type = 'gui' AND uid = '$email' GROUP BY idnum order by student_lastname asc";
		
	}
	else 	{
		$sql1 = "SELECT * FROM crecords1 WHERE sy>='$sy1' AND sy<='$sy2' AND sem = '$sem' AND type = 'gui' AND uid = '$email' GROUP BY idnum order by student_lastname asc";
