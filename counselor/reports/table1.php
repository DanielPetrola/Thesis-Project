...
?>
 <div class="maroon-topp center" style="position: absolute; top: 100%; width: 100%; height: 420%; overflow-y: auto;">
					...
					<table class="table" id="customers-2" >
	                   <thead class="thead">
	                   	<tr>
	                   		<th colspan="7" style="text-align: center; background-color: #fff; color:#000; font-weight:bold;">List of students counseled from <?php echo $sy1;?> to <?php echo $sy2;?>, <?php echo $sem;?> semester.</th>
	                   	</tr>
	                    <tr>
	...
	if ($sem == 'All') {
		...
		$sql1 = "SELECT * FROM crecords1 WHERE sy>='$sy1' AND sy<='$sy2' GROUP BY idnum order by student_lastname asc";
		
	}
	else 	{
		$sql1 = "SELECT * FROM crecords1 WHERE sy>='$sy1' AND sy<='$sy2' AND sem = '$sem' GROUP BY idnum order by student_lastname asc";
