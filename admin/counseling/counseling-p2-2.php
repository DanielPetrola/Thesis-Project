	...
	<body>
		...
		<div class="center white-div2">
			...
			<div class="white-top center">
				...
				<a href="counseling-p1.php"><i class="close-btn fa fa-close fa-lg"></i></a>
			</div>
			<!-- searchbox -->
			<?php
			...
			<!-- table container -->
				...
				<span class="body-title-m">ADD ACADEMIC COUNSELING</span></div>
...
<table class="table" id="table1">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="10%;"> 
      		<form action="counseling-p3.php" method="post">
	                      	<input type="hidden" name="couna_id" value="<?php echo htmlentities($row['id']);?>">
	                      	<button type="submit" name="couna_btn" class="btn btn-success btn-sm">SELECT</button>
	                      	</form>
      </td>
    </tr>
    <?php $cnt=$cnt+1; } 
