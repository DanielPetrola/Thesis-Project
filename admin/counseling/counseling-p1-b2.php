...
$ses_sql1=mysqli_query($conn, "select * from crecords2 where id='$id'");
...
<html>
    ...
    <?php include('../includes/navbar.php');?>
		...
		<div class="center white-div2">
			...
			<button class="btn btn-light btn-sm" onclick="location.href='counseling-p1-b.php'">Back</button></div>			<!-- top of body -->
 ...
 <div class="" style="width:90%; overflow-x: hidden;">
          <form class="" method="post"  action="../includes/guidance_counsel.php" name="registration">
            <div class="form-group ">
              <label for="year" class="form-text text-muted" style="width: 50%;"><b>Filled up by guidance counselor: <?php echo ucfirst($row1['uln'].', '.$row1['ufn']); ?></b></label>
            </div>
            <div class="form-group">
               <small for="counselor" class="form-text text-muted" style="width: 50%;">Year and Semester</small>
               <div class="col-sm-10">
            ...
            <div class="form-group">
                <br>
               <label for="" class="" style="color: green; font-weight:bold;">Acknowledged by: <u><?php echo($row['uln'].", ".$row['ufn']);?></u></label>
            </div>
          </form> 
        </div>
