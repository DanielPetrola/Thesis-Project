...
<html>
	...
	left: 1%;
	bottom: 1%;">
			<button class="btn btn-sm btn-light" onclick="location.href='accounts-p1.php'">Back</button>
    </div>
			<!-- top of body -->
        ...
        <div class="maroon-div4-1">
          ...
          <span class="body-title-m">VIEW ACCOUNT </span>
...
<div class="form-group">
              <form action="accounts-p3.php" method="post">
                <input type="hidden" name="user_id" value="<?php echo htmlentities($row['id']);?>">
                <button type="submit" name="edit_btn" class="btn btn-success btn-sm">Edit</button><br>
              </form>
            </div>
            <div class="form-group">
              <form action="../includes/code.php" method="post">
                <input type="hidden" name="delete_id" value="<?php echo htmlentities($row['id']);?>">
                <button type="submit" onclick="return confirm('Are you sure to remove this account?')" name="delete_btn" class="btn btn-danger btn-sm">Remove Account</button>
              </form>
            </div>
