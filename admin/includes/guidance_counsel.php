...
if (isset($_POST["submit_next"])) {
	...
	createCRecord($conn, $idnum, $lastname, $firstname, $middleinitial, $course, $yearlevel, $date1, $timestart, $timeend, $venue, $reason1, $attendance, $appearance, $attitude, $difficulty, $corrective, $date2, $comments, $commentss, $type, $uln, $ufn, $chk, $gender, $age, $year, $sem, $uid, $status);
