	...
	<body>
		...
		<div class="center white-div2">
			...
			if(isset($_POST['query']))	{
			    ...
			    $query = "SELECT * FROM records WHERE CONCAT(`idnum`, `lastname`, `firstname`, `middleinitial`, `yearlevel`, `course`, `date`) LIKE '%".$valueToSearch."%'";
...
<table class="table" id="table1">
  <thead class="thead" style="background-color: #7e1414;">
    <tr>
      ...
      <th scope="col" style="color: #fff;">PROGRAM</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="10%;"> 
	                      	...
	                      	<button type="submit" name="view_btn" class="btn btn-success btn-sm">VIEW</button>
	                      	</form>
      </td>
    </tr>
    <?php $cnt=$cnt+1; } 
