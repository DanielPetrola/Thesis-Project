...
?>
 <div class="maroon-topp center" style="position: absolute; top: 100%; left: 0.5; width: 99%; height: 500%; overflow-y: auto;">
					...
					<table class="table" id="customers-2" >
	                   <thead class="thead">
	                   	<tr>
	                   		<th colspan="8" style="text-align: center; background-color: #fff; color:#000; font-weight:bold;">Overall list of counseling history.</th>
	                   	</tr>
	                    <tr>
                ...
                include ('../includes/dbh.inc.php');
						$sql1 = "SELECT * FROM crecords1 GROUP BY idnum order by corrective asc";
