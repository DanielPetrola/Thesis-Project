...
if(isset($_POST['history_btn'])){
        if ($_POST['history_type'] == 'arecords'){
			$id = $_POST['history_idnum'];
			
			$ses_sql=mysqli_query($conn, "select * from arecords where id='$id'");
...
<html>
    ...
    <?php include('../includes/navbar.php');?>
		...
		<div class="center white-div2">
			<button class="back-btn" onclick="location.href='history-p1.php'">Cancel</button>
			<!-- top of body -->
			...
			<div class="maroon-div-2 center">
				<span class="body-title-m">VIEW ACADEMIC COUNSELING</span>
		...
		<div class="form-2">
          <form class="" method="post"  action="" name="registration">
            <div class="form-group row">
          	...
          	<div class="form-group row">
              <label for="subject" class="col-sm-2 col-form-label" style="width: 50%;">Subject</label>
               <div class="col-sm-10">
              	<input class="form-control " type="text" id="subject" name="subject" value="<?php echo htmlentities($row['subject']);?>">
          	   </div>
          	</div>
          	<div class="form-group row">
              <label for="section" class="col-sm-2 col-form-label" style="width: 50%;">Section</label>
               <div class="col-sm-10">
              	<input class="form-control " type="text" id="section" name="section" value="<?php echo htmlentities($row['section']);?>">
          	   </div>
          	</div>
          	<div class="form-group row">
              <label for="problem" class="col-sm-2 col-form-label" style="width: 50%;">Brief description of the problem</label>
               <div class="col-sm-10">
              	<textarea rows="5" cols="50" name="problem" id="problem" value="<?php echo htmlentities($row['problem']);?>" ></textarea>
          	   </div>
          	</div>
          	<div class="form-group row">
              <label for="action" class="col-sm-2 col-form-label" style="width: 50%;">Action taken (by faculty, chairman, or dean)</label>
               <div class="col-sm-10">
              	<textarea rows="5" cols="50" name="action" id="action" value="<?php echo htmlentities($row['action']);?>" ></textarea>
          	   </div>
          	</div>
          	<div class="form-group row">
              <label for="recommendation" class="col-sm-2 col-form-label" style="width: 50%;">Recommendation</label>
               <div class="col-sm-10">
              	<textarea rows="5" cols="50" name="recommendation" id="recommendation" value="<?php echo htmlentities($row['recommendation']);?>" ></textarea>
          	   </div>
          	</div>
            <input class="btn btn-primary" type="submit" name="edit_next" value="EDIT"><br><br>
          </form> 
        </div>
...
<?php 
		...
		else if ($_POST['history_type'] == 'crecords') {
			$id = $_POST['history_idnum'];
