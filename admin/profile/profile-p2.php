		...
		<form class="" method="post">
			<div  style="position: absolute; top: 10%; width: 45%;">
            	<div class="form-group">
					    ...
					    <input type="tel" pattern="(0,9){2}-(0,9){4}-(0,9){3}" class="form-control  form-control-sm" name="idnum" id="idnum" value="<?php echo $row['idnum']?>" readonly>
				</div>
			    <div class="form-group">
			    ...
			    <div class="form-group">
				    	...
				    	<select class="form-control " type="radio" id="role" name="role" required>
			                ...
			                <option class="form-control " >Counselor</option>
			            </select>
				</div>
			    <div class="form-group">
				    	...
				    	<select class="form-control" type="radio" id="position" name="position" required>
			                ...
			                <option class="form-control " >Dean</option>
			                <option class="form-control " >Instructor</option>
			                <option class="form-control " >Counselor</option>
			            </select>	
			    </div>
			</div>
