...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/datetime/1.1.0/css/dataTables.dateTime.min.css">
        ...
        <body>
            ...
            <div class="center white-div2">
                ...
                <button class="btn btn-primary btn-sm " onclick="location.href='../includes/graph1.inc.php.php'">GRAPH</i></button>       </div>
               <!-- table container -->
                <div class="maroon-div center">

                    <table id="customers" >
                        <tr>
                          <th width="30%;" style="border-bottom: solid #F0AD4E 7px;"><a style="color:  #F0AD4E;" href="reports-p1.php">STUDENTS</a></th>
                          <th width="30%;"><a href="reports-p2.php">PROBLEMS</a></th>
...
<div class="" style="position: absolute; top: 13%; width: 99%; left: 0.5%;">
    ...
    <div class="form-group sm-2">
    <button class="btn btn-white btn-sm" name="" id="" onclick="location.href='reports-p1.php'"> Reset </button> 
    </div> 
</div>
